return {
  ...
  -- Auto close HTML tags (Merged duplicates)
  {
  ...
  -- Flutter tools (Merged 3 duplicate declarations into 1)
  {
            ...
            require("dap").configurations.dart = {
              {
                ...
                dartSdkPath = "/home/YOUR_USER/flutter/bin/cache/dart-sdk",
                flutterSdkPath = "/home/YOUR_USER/flutter",
  ...
  -- Show search matches in the scrollbar
  {
  ...
  -- Mason / Treesitter definitions (Separated for proper syntax)
  {
    "williamboman/mason.nvim",
    opts = {
      auto_install = true,
      ensure_installed = {
        "gopls", "golangci-lint", "prettier", "copilot-language-server", "delve",
        "html", "vtsls", "css", "json-lsp", "tailwindcss-language-server",
        "marksman", "bash-language-server", "yaml-language-server",
        "dockerfile-language-server", "svelte-language-server",
      },
    },
  },
  {
